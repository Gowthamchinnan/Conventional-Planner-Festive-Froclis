...
public partial class AdminViewHallBookingDetails : System.Web.UI.Page
{
    SqlConnection con;
    ...
    void bindgrid()
    {
        ...
        adp = new SqlDataAdapter("select * from hbtable where bdate=@bdate", con);
        adp.SelectCommand.Parameters.AddWithValue("bdate", TextBox1.Text);
        dt = new DataTable();
        adp.Fill(dt);
