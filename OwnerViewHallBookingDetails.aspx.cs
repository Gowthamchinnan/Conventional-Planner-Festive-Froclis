...
public partial class OwnerViewHallBookingDetails : System.Web.UI.Page
{
    SqlConnection con;
    ...
    void bindgrid()
    {
        ...
        adp = new SqlDataAdapter("select * from hbtable where hid in (select hid from htable where uname=@uname)", con);
