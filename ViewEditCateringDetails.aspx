<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewEditCateringDetails.aspx.cs" Inherits="ViewEditCateringDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table border="0" cellspacing ="20" align="center" width ="70%">
        ...
        <tr>
            ...
            DataKeyNames="csname" onrowediting="GridView1_RowEditing" 
            onrowupdating="GridView1_RowUpdating" BackColor="#CCCCCC" BorderColor="#999999" 
                        ...
                        <Columns>
                            <asp:BoundField DataField ="csname" HeaderText ="Service Name" />
