...
public partial class ViewEditCateringDetails : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataReader rs;
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            string csname = GridView1.DataKeys[e.RowIndex].Value.ToString();
            ...
            cmd = new SqlCommand("update ctable set name=@name,address=@address,city=@city, cno=@cno, mailid=@mailid where csname=@csname", con);
